...
This example shows you LoRA (Low-Rank Adaptation) implementation from scratch (manually) in a step-by-step manner (without PEFT package), and also shows you clear ideas behind this implementation in IPython notebook.
...
Unlike examples in official repository, here I download pre-trained models to focus on LoRA implementation.
...
To run this example, please install prerequisite's software and setup your environment as follows.
